...
//			System.out.println("Woop, average error (" + epochAverageError + ") is lower than threshold after " + epoch + " epochs");
//		if (tc.maxChange > maxWeightChange)
//			System.out.println("Woop, weightChange (" + tc.maxChange + ") is lower than threshold after " + epoch + " epochs");
//		if (tc.percentMisclassifiedTuples > maximumMisclassificationPercentage)
//			System.out.println("Woop, misclassified (" + tc.percentMisclassifiedTuples + ") is lower than threshold after " + epoch + " epochs");
